...
## 📌**주요 기능**
- **고성능 처리를 위한 Kafka** 이벤트 기반 **상품 주문**
  - 비동기 처리로 마이크로서비스 간 결합도를 줄이고 확장성에 뛰어난 이벤트 기반 통신 사용
<details>
...
- **Redis 싱글 스레드 특성**을 활용한 상품 재고 관리 및 **동시성 처리**
...
- **OpenFeign**과 **Resilience4j**를 활용한 마이크로서비스 간 통신
...
- 해결 방법: Resilience4j의 **Circuit Breaker**와 **Time Limiter, Retry** 패턴을 적용하여 통신 장애 시 서비스의 연속성 보장

### **트랜잭션 롤백 시, 의도치 않은 카프카 이벤트 발행 문제 해결** ([자세히 보기](https://yenjjun187.tistory.com/1043))
