...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, PaymentRequestEventDto> kafkaConsumer() {
    ...
    @Bean
    ConcurrentKafkaListenerContainerFactory<String, PaymentRequestEventDto> kafkaContainerFactory() {
